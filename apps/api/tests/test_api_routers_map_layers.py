...
def test_listar_capas_incluye_broadband_coverage(api_client: TestClient) -> None:
    ...
    assert "administrative_boundaries" in ids
...
def test_obtener_capa_devuelve_featurecollection(api_client: TestClient) -> None:
    ...
    assert body["layer"]["id"] == "broadband_coverage"
...
def test_obtener_capa_inexistente_devuelve_404(api_client: TestClient) -> None:
